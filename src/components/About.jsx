function About() {
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-between gap-8 p-6 min-h-screen bg-gradient-to-r from-orange-100 via-white to-orange-50">
      
      {/* Your Name on the Top-Left Corner */}
      <div className="absolute top-4 left-4 text-xl font-bold text-[#f3ab85] z-10">
        Jhona
      </div>
      ...
      {/* Text Content */}
      <div className="w-full md:w-1/2 text-center md:text-left mt-8 md:mt-0 z-20">
